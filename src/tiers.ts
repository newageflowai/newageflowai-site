...
export const TIERS: Tier[] = [
  ...
  },
  {
    ...
    price: "$49",
    cadence: "/ month",
    blurb: "AI-assisted trade levels and live context for ES & NQ.",
    features: [
  ...
  },
  {
    ...
    price: "$79",
    cadence: "/ month",
    blurb: "Everything in Early Access plus deeper setup.",
    features: [
  ...
  },
  {
    ...
    price: "$99",
    cadence: "/ month",
    blurb: "Full access — direct support and bespoke setups.",
    features: [
